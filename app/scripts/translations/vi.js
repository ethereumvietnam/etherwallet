...
vi.data = {
  ...
  NAV_GenerateWallet:   'Đăng Ký',
  NAV_BulkGenerate:     'Bulk Generate',
  NAV_SendEther:        'Gửi Ether',
  NAV_SendTokens:       'Gửi Tokens',
  NAV_Offline:          'Gửi Offline',
  NAV_WithdrawDAO:      'Rút DAO',
  DAO_TitleLong:        'Đổi DAO - ETH',
  NAV_ClaimDGD:         'Nhận DGD',
  DGD_TitleLong:        'Nhận DGD Tokens',
  NAV_MyWallets:        'Ví Của Tôi',
  NAV_ViewWallet:       'Đăng Nhập',
  NAV_Help:             'Hỗ Trợ',
  NAV_Contact:          'Liên Hệ',
  ...
  x_JsonDesc:           'Đây là file ví không được mã hóa (unencrypted). File này cho phép bạn hay bất cứ ai truy cập vào ví và tham gia giao dịch mà không cần mật khẩu!',
  x_PrintShort:         'Print',
  ...
  /* Header */
  MEW_Warning_1:        'Cảnh giác với các website giả mạo MyEtherWallet. Kiểm tra kỹ tên miền trước khi sử dụng!',
  ...
  sidebar_AccountAddr:  'Địa Chỉ Ví: ',
  sidebar_AccountBal:   'Số Dư: ',
  ...
  /* Generate Wallets */
  GEN_desc:               'Khởi tạo nhiều ví cùng lúc: ',
  GEN_Label_1:            'Nhập mật khẩu (ít nhất 9 ký tự)',
  GEN_Placeholder_1:      'Lưu ý: Ghi nhớ mật khẩu!',
  GEN_SuccessMsg:         'Thành Công!',
  GEN_Warning:            '**Lưu Ý: Bạn sẽ cần file ví Keystore/JSON File và Mật Khẩu hoặc Private Key** để đăng nhập. Ghi nhớ và sao lưu các dữ liệu! MyEtherWallet là ví Client-Side, tất cả các thông tin đều do người sử dụng nắm giữ, nếu thất lạc thông tin sẽ không thể khôi phục được. Tham khảo [help page](https://www.myetherwallet.com/#help) để biết thêm chi tiết.',
  GEN_Label_2:            'Lưu file ví Keystore/JSON hoặc Private Key. Lưu ý: Ghi nhớ mật khẩu.',
  GEN_Label_3:            'Lưu Địa Chỉ.',
  GEN_Label_4:            'Print your paper wallet, or store a QR code verison. (optional)',

  /* Bulk Generate Wallets */
  BULK_Label_1:           'Số Lượng Ví',
  BULK_Label_2:           'Khởi Tạo Ví',
  BULK_SuccessMsg:        'Thành Công!',

  /* Sending Ether and Tokens */
  SEND_addr:             'Địa Chỉ Nhận: ',
  SEND_amount:           'Số Lượng Gửi: ',
  SEND_amount_short:     'Số Lượng',
  SEND_custom:           'Chọn Số Lượng',
  SEND_gas:              'Phí',
  SEND_generate:         'Generate Signed Transaction',
  SEND_raw:              'Raw Transaction',
  SEND_signed:           'Signed Transaction',
  SEND_trans:            'Gửi',
  SEND_TransferTotal:    'Gửi tất cả',
  SENDModal_Title:       'Cảnh Báo! ',
  /* full sentence reads "You are about to send "10 ETH" to address "0x1234". Are you sure you want to do this? " */
  SENDModal_Content_1:   'Bạn đang gửi',
  SENDModal_Content_2:   'tới địa chỉ',
  SENDModal_Content_3:   'Bạn có muốn tiếp tục?',
  SENDModal_Content_4:   'Lưu Ý: Nếu gặp lỗi, có khả năng số dư ETH không đủ để chi trả phí khi gửi. Phí chi trả bằng ETH.',
  SENDModal_No:          'Hủy',
  SENDModal_Yes:         'Xác Nhận',
  ...
  /* Send Transaction */
  TRANS_desc:            'Để gửi Tokens, xin vui lòng sử dụng "Gửi Token".',
  ...
  MYWAL_View:             'Theo Dõi',
  MYWAL_Remove:           'Xóa',
  MYWAL_RemoveWal:        'Hủy Ví:',
  MYWAL_WatchOnly:        'Theo Dõi',
  MYWAL_Viewing:          'Viewing Wallet: ',
  MYWAL_Hide:             'Hide Wallet Info',
  MYWAL_Edit:             'Edit Wallet: ',
  MYWAL_Name:             'Tên Ví',
  MYWAL_Content_1:        'Cảnh Báo! Bạn Đang Xóa Ví Này!.',
  ...
  Translator_Desc:      'Đối Tác:',
  TranlsatorName_1:     'Ethereum Vietnam', /* <a href="facebook.com/ethereumvietnam>Ethereum Vietnam</a> */
  TranlsatorAddr_1:     'www.ethereumvn.com',
